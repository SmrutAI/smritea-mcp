...
/**
 * Check if a given object implements the EntityExtractionConfig interface.
 */
export function instanceOfEntityExtractionConfig(value: object): value is EntityExtractionConfig {
    return true;
}

export function EntityExtractionConfigFromJSON(json: any): EntityExtractionConfig {
    return EntityExtractionConfigFromJSONTyped(json, false);
}

export function EntityExtractionConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityExtractionConfig {
    if (json == null) {
        return json;
    }
    return {
...
export function EntityExtractionConfigToJSON(json: any): EntityExtractionConfig {
    return EntityExtractionConfigToJSONTyped(json, false);
}

export function EntityExtractionConfigToJSONTyped(value?: EntityExtractionConfig | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
