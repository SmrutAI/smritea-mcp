 ...
 * @export
 */
export const FactExtractionConfigStrategyEnum = {
    LlmFactExtraction: 'llm_fact_extraction'
} as const;
export type FactExtractionConfigStrategyEnum = typeof FactExtractionConfigStrategyEnum[keyof typeof FactExtractionConfigStrategyEnum];


/**
 * Check if a given object implements the FactExtractionConfig interface.
 */
export function instanceOfFactExtractionConfig(value: object): value is FactExtractionConfig {
    return true;
}

export function FactExtractionConfigFromJSON(json: any): FactExtractionConfig {
    return FactExtractionConfigFromJSONTyped(json, false);
}

export function FactExtractionConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): FactExtractionConfig {
    if (json == null) {
        return json;
    }
    return {
...
export function FactExtractionConfigToJSON(json: any): FactExtractionConfig {
    return FactExtractionConfigToJSONTyped(json, false);
}

export function FactExtractionConfigToJSONTyped(value?: FactExtractionConfig | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
