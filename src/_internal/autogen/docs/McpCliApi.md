...
|------------- | ------------- | -------------|
| [**cliAuthorize**](McpCliApi.md#cliauthorize) | **GET** /api/v1/cli/authorize | CLI OAuth Authorization |
| [**cliTokenExchange**](McpCliApi.md#clitokenexchange) | **POST** /api/v1/cli/token | CLI OAuth Token Exchange |
| [**cliTokenRefresh**](McpCliApi.md#clitokenrefresh) | **POST** /api/v1/cli/token/refresh | CLI OAuth Token Refresh |
| [**createApiKey**](McpCliApi.md#createapikey) | **POST** /api/v1/dashboard/organizations/{orgId}/api-keys | Create API key |
| [**listApps**](McpCliApi.md#listapps) | **GET** /api/v1/dashboard/apps | List applications |
